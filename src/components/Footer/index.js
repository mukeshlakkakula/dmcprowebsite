            ...
            <section className="footer">
                <div className="container">
                    <div className="detail">
                        <h3>Dmcpro.in</h3>
                        <p>Revolutionizing Digital Marketing with Authentic Engagement. At Dmcpro.in, we understand the importance of creating meaningful interactions that drive real results. Our unique selling proposition (USP) lies in our ability to engage genuine customers.</p>
                        <h5>Get in touch</h5>
